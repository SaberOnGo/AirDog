...
// PM25_SET  ->  PA0
#define PM25_SET_Pin                GPIO_Pin_0
#define PM25_SET_PORT          GPIOA    
#define PM25_SET_Open()      IO_H(PM25_SET_PORT,  PM25_SET_Pin)
#define PM25_SET_Close()      IO_L(PM25_SET_PORT,   PM25_SET_Pin)
...
#define CHRG_Indicate_Pin           
#define CHRG_Indicate_PORT     
...
// 2: Light_1 -> PC5 ->  ADC1 Channel 15
#define LIGHT_1_Pin                   GPIO_Pin_5
#define LIGHT_1_PORT             GPIOC
#define LIGHT_1_ADC_x           ADC1
#define LIGHT_1_Channel        ADC_Channel_15


// 3: 振动传感器 CAPKEY -> PB0
#define CAPKEY_Pin                    GPIO_Pin_0
#define CAPKEY_PORT              GPIOB
#define CAPKEY_ADC_x            ADC1
#define CAPKEY_Channel         ADC_Channel_8

// 外部中断硬件IO 定义
#define CAPKEY_PinSource           GPIO_PinSource0
#define CAPKEY_PortSource        GPIO_PortSourceGPIOB
#define EXTI_Line_CAPKEY          EXTI_Line0
#define EXTI_CAPKEY_IRQn       EXTI0_IRQn
#define CAPKEY_Read()                IO_READ_IN(CAPKEY_PORT, CAPKEY_Pin)   
#define EXTI_CAPKEY_IRQHandler        EXTI0_IRQHandler 
