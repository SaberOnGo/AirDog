...
#ifndef __BOARD_AIRDOG_V12_H__
#define  __BOARD_AIRDOG_V12_H__

/**************************************************************************************
主板管脚定义文件
主板硬件版本:  AirDog V1.2 版本, 2018-9-26
日期: 2017-12-09
...
// RT9193 使能控制 IO ->  
#define RT_EN_Pin                GPIO_Pin_13
#define RT_EN_PORT          GPIOC
#define RT_EN_Open()      IO_H(RT_EN_PORT,  RT_EN_Pin)
#define RT_EN_Close()      IO_L(RT_EN_PORT,  RT_EN_Pin)
#define RT_EN_Read()      IO_READ_OUT(RT_EN_PORT,  RT_EN_Pin)
#define RT_EN_Status()    RT_EN_Read()
...
// 外部中断硬件IO 定义
#define PwrOffDet_Pin                          GPIO_Pin_14
#define PwrOffDet_PORT                    GPIOC
#define PwrOffDet_PinSource           GPIO_PinSource14
#define PwrOffDet_PortSource        GPIO_PortSourceGPIOC
#define EXTI_Line_PwrOffDet           EXTI_Line14
#define EXTI_PwrOffDet_IRQn         EXTI15_10_IRQn
#define PwrOffDet_Read()                 IO_READ_IN(PwrOffDet_PORT, PwrOffDet_Pin)   
#define EXTI_PwrOffDet_IRQHandler        EXTI15_10_IRQHandler
