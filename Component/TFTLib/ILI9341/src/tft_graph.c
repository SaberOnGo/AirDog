...
// attention: sizeof(colorBuf) == w * h
void LCD_putPixelRect(u16 x1, u16 y1, u16 w, u16 h, u16 * colorBuf) {
	u32 count = w * h;
    LCD_setAddressWindowToWrite(x1, y1, (u16) (x1 + w - 1), (u16) (y1 + h - 1));
    LCD_setSpi16();
    dmaFill16Rect(colorBuf, count);
    LCD_setSpi8();
}
...
void LCD_setVerticalScrolling(u16 startY, u16 endY)
{
	...
	d[0] = startY;
	d[1] = (u16) (Y_MAX_PIXEL - startY - endY);
	d[2] = endY;
