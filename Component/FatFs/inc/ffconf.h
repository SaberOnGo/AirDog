...
#define _MAX_LFN     50   //255  /* Maximum LFN length to handle (12 to 255) */
...
#define _STRF_ENCODE   0 // 3 /* 0:ANSI/OEM, 1:UTF-16LE, 2:UTF-16BE, 3:UTF-8 */
...
#define _VOLUME_STRS	"NOR","ROM","SD1","SD2","USB1","USB2","USB3"
