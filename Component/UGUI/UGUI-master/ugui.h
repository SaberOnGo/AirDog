/* -------------------------------------------------------------------------------- */
/* -- μGUI - Generic GUI module (C)Achim D?bler, 2015                            -- */
/* -------------------------------------------------------------------------------- */
// μGUI is a generic GUI module for embedded systems.
...
//
// * The μGUI module is a free software and there is NO WARRANTY.
...
typedef void* (*DrvFillArea_FuncType)(UG_S16, UG_S16, UG_S16, UG_S16);
...
#define C_EXACT_GREY                   0xbdf7
#define C_LightSlateGray               0x7453
